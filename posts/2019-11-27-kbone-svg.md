...
date: 2019-11-27
featured_image: https://images.unsplash.com/photo-1489769002049-ccd828976a6c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80
summary: 本文针对单个页面上出现大量 HTML inline SVG 的实战场景，通过识别并转换成 background-image，来实现小程序 kbone 对 SVG 的支持。
---
...
<p style="text-align: center">小程序实例的典型架构</p>
